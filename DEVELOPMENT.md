...
```bash
git remote add encore encore://visual-design-tool-5762
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/visual-design-tool-5762/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/visual-design-tool-5762/settings/integrations/github)
